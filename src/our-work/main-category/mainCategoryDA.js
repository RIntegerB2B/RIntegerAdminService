            ...
            if (err) { // if it contains error return 0
               ...
               SuperCategory.findById(req.body._id, function (err, superCat) {
                if (err) {
                    ...
                    const PATH = appSetting.workUplaodPath +  superCat.categoryName + '/' + req.body.mainCategoryName;
                    mkdirp(PATH);
...
exports.mainCategoryDelete = function (req, res) {
    SuperCategory.findById(req.params.categoryId, function (err, category) {
        if (err) {
            ...
            maincategory.remove();
const PATH = appSetting.workUplaodPath +  category.categoryName + '/' + maincategory.mainCategoryName ;
