...
/*  imageServerPath: 'http://localhost/RInteger/serviceproviders/',
  ...
  /*   workServerPath: 'http://localhost/RIntegerWorks/',
    ...
    imageServerPath: process.env.IMAGE_SERVER_PATH || 'https://rinteger.com/admin/images/ourwork/',
    imageUploadPath:process.env.IMAGE_UPLOAD_PATH || '/home/ubuntu/app/rinteger-admin/Rinteger-admin/images/ourwork/' ,
