...
exports.createMarketCustomer = function (req, res) {
    ...
    for (var i = 0; i <= req.body.length - 1; i++) {
        ...
        fullMarketCustomer[i].customerName = req.body[i].customerName;
        ...
        fullMarketCustomer[i].email = req.body[i].email;
...
exports.singleMarketCustomer = function (req, res) {
    ...
    singMarketCustomer.customerName = req.body.customerName;
    ...
    singMarketCustomer.email = req.body.email;
...
exports.marketCustomerDetailsEdit = function (req, res) {
    MarketCustomer.findById(req.params.id, function (err, editMarketCustomer) {
        if (err) {
            ...
            editMarketCustomer.customerName = req.body.customerName;
            ...
            editMarketCustomer.email = req.body.email;
